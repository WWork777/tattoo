...
export default function Sertificate() {
  ...
  const reviews = [
    ...
    {
      id: 7,
      image: "/obuchenie/sertificate/40.webp",
      author: "Александр Новиков",
      shortText:
        "Отличное место для релакса. Профессиональный подход и качественные услуги...",
      fullText:
    ...
    {
      id: 8,
      image: "/obuchenie/sertificate/41.webp",
      author: "Александр Новиков",
      shortText:
        "Отличное место для релакса. Профессиональный подход и качественные услуги...",
      fullText:
    ...
    {
      id: 9,
      image: "/obuchenie/sertificate/42.webp",
      author: "Александр Новиков",
      shortText:
        "Отличное место для релакса. Профессиональный подход и качественные услуги...",
      fullText:
    ...
    {
      id: 10,
      image: "/obuchenie/sertificate/43.webp",
      author: "Александр Новиков",
      shortText:
        "Отличное место для релакса. Профессиональный подход и качественные услуги...",
      fullText:
    ...
    {
      id: 11,
      image: "/obuchenie/sertificate/44.webp",
      author: "Александр Новиков",
      shortText:
        "Отличное место для релакса. Профессиональный подход и качественные услуги...",
      fullText:
