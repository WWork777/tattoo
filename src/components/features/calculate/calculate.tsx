          ...
          <div className={styles.step}>
            ...
            <div className={styles.radioGrid}>
              {hasTattoosOptions.map(option => (
                <label 
                  key={option}
                  className={`${styles.radioLabel} ${formData.hasTattoos === option ? styles.active : ''}`}
                >
                  <input
                    type="radio"
                    name="hasTattoos"
          ...
          <div className={styles.step}>
            ...
            <div className={styles.radioGrid}>
              {placementOptions.map(place => (
                <label 
                  key={place}
                  className={`${styles.radioLabel} ${formData.placement === place ? styles.active : ''}`}
                >
                  <input
                    type="radio"
                    name="placement"
          ...
          <div className={styles.step}>
            ...
            <div className={styles.radioGrid}>
              {sketchOptions.map(option => (
                <label 
                  key={option}
                  className={`${styles.radioLabel} ${formData.sketchType === option ? styles.active : ''}`}
                >
                  <input
                    type="radio"
                    name="sketchType"
        ...
        return (
          <div className={styles.step}>
            <div className={styles.stepHeader}>
              ...
              <p className={styles.stepSubtitle}>Необязательно, но поможет мастеру лучше понять вашу идею</p>
            </div>
  ...
  return (
    <section className={styles.section}>
      <div className={styles.container}>
        ...
        <p className={styles.subtitle}>Заполните форму и мастер свяжется с вами для расчета</p>
          ...
          {submitStatus === 'success' ? (
            ...
            <>
              ...
              <div className={styles.buttons}>
                ...
                >
                  {isSubmitting ? 'Отправка...' : currentStep === totalSteps ? 'Отправить заявку' : 'Далее'}
                </button>
              </div>
            </>
          )}
