    ...
    <section className="container" id="special">
      ...
      <div className={styles.grid}>
        ...
        <ImageCard
          ...
          text={["на пирсинг", "на тату", "с индивидуальным дизайном", "любой номинал от 3000₽"]}
          imageSrc="special5"
          onOpenModal={openModal}
          btn={false}
        />
        <ImageCard
          ...
          text={["проколы ушей", "проколы на лице", "проколы на теле", "проколы во рту", "украшения из титана"]}
          imageSrc="special6"
          onOpenModal={openModal}
          btn={false}
        />
