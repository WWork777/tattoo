...
const Hero = () => {
  ...
  const slides = [
    {
      id: 1,
      title: "Soprano – Это место, где работают художники",
      subtitle:
        "Для нас тату – это не просто рисунок на коже – это миг, который вы хотите пронести с собой навсегда. Мы понимаем важность этого момента и подходим к процессу как настоящие художники, создавая для вас уникальный проект.",
