...
export async function POST(request: NextRequest) {
  try {
    ...
    const hasTattooExperience = formData.get('hasTattooExperience') as string
    const hasDrawingExperience = formData.get('hasDrawingExperience') as string
...
<b>Вопрос 2: Есть опыт рисования?</b>
${escapeHtml(hasDrawingExperience)}

<b>Вопрос 3: Когда хотел бы начать обучение?</b>
